...
//javascript is not a strictily styped language[No data types defintion before hand]
//javascript supports number, string and boolean scalar types
//literals - for boolean we true for true,false for false
//literals - for string we can either enclose the string with sigle or double quote
// variable that are declared in a js file directly not part of  function is
//considered global, it will be available through out the file

a=90 // no daa type specification a is variable so is numeric literal
b=false
c="ram"
d=90.43
